...
return (
  ...
  */
  ...
  if (true) {
    ...
    module.exports = __webpack_require__(129)(ReactIs.isElement, throwOnDirectAccess);
  } else {
  ...
  var _Subscription = __webpack_require__(139);
  ...
  */
  selectorFactory) {
    ...
    return function wrapWithConnect(WrappedComponent) {
      ...
      var Connect = function (_Component) {
        ...
        Connect.prototype.UNSAFE_componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
  ...
  var ServerReactRootIndex = __webpack_require__(179);
  ...
  function getInitConfig(callback) {
    if (typeof globalInitConfig === "undefined") {
      $.getScript("/int/script", function () {
        callback(globalInitConfig);
      });
    } else {
      callback(globalInitConfig);
    }
  ...
  function connectUrl(url) {
    //扩展ke,区分html和action
    var prefix_ke = "ke/web/";
    if (/\.html($|\?)/.test(url)) {
      prefix_ke = "";
    }

    // eg: url = '$ke_web_url/ke/vtm/teamCate/loadAll'
    return url.replace(/\$(.*?)\//g, function (strMatch, serverName) {
      var prefix_url = globalInitConfig[serverName] || strMatch;
      if ("ke_web_url" === serverName) {
        prefix_url += prefix_ke;
      }
      return prefix_url;
    });
  }
  ...
  var SysRouter = {
    ...
    $c: connectUrl,
    //转跳路径
    $r: function $r(url, method) {
      getInitConfig(function () {
        var _url = connectUrl(url);
        if (method === "open") {
          window.open(_url);
          return;
        }
  ...
  var _Provider = __webpack_require__(132);
  ...
  var _connect = __webpack_require__(133);
  ...
  var React = exports.React = __webpack_require__(31);
  var ReactDOM = exports.ReactDOM = __webpack_require__(101);
  var Redux = exports.Redux = __webpack_require__(53);
  var ReactRedux = exports.ReactRedux = __webpack_require__(102);
  var SysRouter = exports.SysRouter = __webpack_require__(100);
  ...
  */
  ...
  var _mapDispatchToProps = __webpack_require__(134);

  var _mapDispatchToProps2 = _interopRequireDefault(_mapDispatchToProps);

  var _mapStateToProps = __webpack_require__(135);

  var _mapStateToProps2 = _interopRequireDefault(_mapStateToProps);

  var _mergeProps = __webpack_require__(136);

  var _mergeProps2 = _interopRequireDefault(_mergeProps);

  var _selectorFactory = __webpack_require__(137);
  ...
  var _verifySubselectors = __webpack_require__(138);
  ...
  */
  ...
  /* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(99), __webpack_require__(203)(module)))
