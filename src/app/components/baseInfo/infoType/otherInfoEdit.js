...
class OtherInfoEdit extends Component {
    constructor(props) {
        super(props);
        this.state = {
            desc: '',
    ...
    save = (callback) => {
        this.props.form.validateFields((errors, values) =>{
            ...
            const updateItem = {...this.props.baseData, ...values, scope, attrType, orgId, validateType: 1 };
            axios.put(`/sysware/api/org-udef/update`, updateItem, { headers: { 'Authorization': Cookies.get('Authorization')}}).then(res => {
...
// OtherInfoEdit = Form.create()(OtherInfoEdit);
